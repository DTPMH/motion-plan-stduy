...
int main(int argc, char* argv[]) try
{
	...
	*/
	...
	cv::VideoWriter video("test.avi",CV_FOURCC('X','V','I','D'),30,Size(640,480));
		...
		*/
		...
		if (!colorImage_2dCamera.empty())
		{
			cv::imshow("Rgb", colorImage_2dCamera);
					std::string pathColor = pathOutput + pmhnidaye+".png";
		    ...
		    temp<<pmh;
	        pmhnidaye=temp.str();
	        resize(colorImage_2dCamera, colorImage_2dCamera, Size(640,480));	
